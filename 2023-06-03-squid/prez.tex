	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			...
			\only<2-2>{
				Microgrant Program:
				\begin{itemize}
					\item 70+ Microgrants awarded
					\item 23 countries
					\item 16+ publications
					\item 30+ libraries, $\sim$6k commits
			...
			\only<5-5>{
				\begin{itemize}
					\item UnitaryHACK
					      \begin{itemize}
						      \item 33 participating projects
						      \item 152 bounties with cash prizes worth over \$15k
						      \item \url{https://unitaryhack.dev}
					      \end{itemize}
