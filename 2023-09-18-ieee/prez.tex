			...
			\uncover<3->{
				\begin{center}
					\begin{tikzpicture}
						...
						\fill (1.5, 0) circle[radius=0pt] node[below] {$\lambda = 1$};

						\draw[bottom color=BrickRed, top color=white,opacity=0.3, draw=none] (0,0) rectangle (1.5, 3.9);% -- (0,4.2) -- (1.5,3.9) -- (1.5,0) (0.75, 4);
...
\begin{frame}{Let's try Mitiq!}
	\begin{center}
		\qrcode{https://github.com/unitaryfund/mitiq-tutorial/}
...
\begin{frame}[fragile]{Executors Continued}
	...
	\end{verbatim}
	\begin{align*}
		\mathtt{QPROGRAM}      & = \mathtt{cirq.Circuit} \cup \mathtt{qiskit.QuantumCircuit} \cup \mathtt{pyquil.Program} \\
		\mathtt{QuantumResult} & = \mathtt{float} \cup \mathtt{density} \cup \mathtt{bitstring}
	\end{align*}
	\todo{replace circuit names with images}
...
\begin{frame}{Interested in this work?}
	...
	\end{figure}
	\begin{center}
		\qrcode{https://unitary.fund/careers/}
